...
// screenshots, see snes.krom.test.ts. Paths are in https://github.com/PeterLemon/SNES, and
// in the bundle made by scripts/fetch-krom-tests.ts. The screenshot is next to the ROM, with the
// same name.

export const KROM_BUNDLE = new URL(import.meta.resolve('@test/fixtures/krom/krom.bundle.gz'));
